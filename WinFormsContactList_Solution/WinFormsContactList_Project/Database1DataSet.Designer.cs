...
namespace WinFormsContactList_Project {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ContactDataTable : global::System.Data.TypedTableBase<ContactRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ContactRow AddContactRow(int ContactNumber, string FirstName, string LastName, string Email) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public ContactRow FindByContactNumber(int ContactNumber) {
        ...
        public partial class ContactRow : global::System.Data.DataRow {
            ...
            public int ContactNumber {
                get {
                    return ((int)(this[this.tableContact.ContactNumberColumn]));
                }
                set {
...
namespace WinFormsContactList_Project.Database1DataSetTableAdapters {
    ...
    public partial class ContactTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Contact] ([ContactNumber], [FirstName], [LastName], [Email]) V" +
                "ALUES (@ContactNumber, @FirstName, @LastName, @Email);\r\nSELECT ContactNumber, Fi" +
                "rstName, LastName, Email FROM Contact WHERE (ContactNumber = @ContactNumber)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Contact] SET [ContactNumber] = @ContactNumber, [FirstName] = @FirstName, [LastName] = @LastName, [Email] = @Email WHERE (([ContactNumber] = @Original_ContactNumber) AND ((@IsNull_FirstName = 1 AND [FirstName] IS NULL) OR ([FirstName] = @Original_FirstName)) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)));
SELECT ContactNumber, FirstName, LastName, Email FROM Contact WHERE (ContactNumber = @ContactNumber)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WinFormsContactList_Project.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ContactNumber, FirstName, LastName, Email FROM dbo.Contact";
        ...
        public virtual int Delete(int Original_ContactNumber, string Original_FirstName, string Original_LastName, string Original_Email) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_ContactNumber));
        ...
        public virtual int Insert(int ContactNumber, string FirstName, string LastName, string Email) {
        ...
        public virtual int Update(int ContactNumber, string FirstName, string LastName, string Email, int Original_ContactNumber, string Original_FirstName, string Original_LastName, string Original_Email) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_ContactNumber));
            if ((Original_FirstName == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Email, int Original_ContactNumber, string Original_FirstName, string Original_LastName, string Original_Email) {
            return this.Update(Original_ContactNumber, FirstName, LastName, Email, Original_ContactNumber, Original_FirstName, Original_LastName, Original_Email);
        }
    }
